...
if(!class_exists('HGR_XTND')) {
	...
	*/
	...
	function vc_installed_min_version_notice() {
		return '<div class="hgr_notice hgr_notice_error"><p><strong>HighGrade Extender is a add-on for Visual Composer plugin</strong>, therefore before activation of HighGrade Extender please install and activate Visual Composer - <strong>minimum version: 5.0</strong></p></div>';
	}
	...
	function hgr_xtnd_install(){
		update_option('hgr_xtnd_version', '3.2' );
	}
