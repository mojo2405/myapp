<?php
/**
 * Upshot Theme: Blog page, search results page
 * @package WordPress
  ...
  <div class="container"> 
    ...
    <div class="vc_col-md-9 vc_col-sm-12 vc_col-xs-12">
      <h1 class="titleSep" style="margin-bottom:10px;">
        <?php esc_html_e('You\'ve searched for: ', 'upshot'); ?>
      ...
      <div class="post">
        ...
        <h3><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php esc_html_e('Permanent Link to', 'upshot');?> <?php the_title_attribute(); ?>">
          <?php the_title(); ?>
          </a></h3>
      ...
      <h3 style="margin-bottom:10px;margin-top:30px;">
        <?php esc_html_e('Some recent posts you might be interested in: ', 'upshot'); ?>
      </h3>
