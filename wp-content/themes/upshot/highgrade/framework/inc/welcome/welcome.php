    ...
    class Redux_Welcome {
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = esc_html__( "Support hash could not be generated. Please try again later.", 'weddingz' );
            }
        ...
        public function tabs() {
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php echo ($selected == 'redux-about' ? 'nav-tab-active' : ''); ?>"
                    ...
                    <?php esc_attr_e( "What's New", 'weddingz' ); ?>
                    ...
                    <?php esc_attr_e( 'Extensions', 'weddingz' ); ?>
                    ...
                    <?php esc_attr_e( 'Changelog', 'weddingz' ); ?>
                    ...
                    <?php esc_html_e( 'Credits', 'weddingz' ); ?>
                    ...
                    <?php esc_attr_e( 'Support', 'weddingz' ); ?>
                    ...
                    <?php esc_attr_e( 'Status', 'weddingz' ); ?>
                </a>
            </h2>
        <?php
        }
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'weddingz' ), esc_html($contributor->login) ) )
                );
